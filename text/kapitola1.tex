...
$i$-th element begins in $R$. Helper array $P$ consumes roughly $\Theta(n\log |R|)$ bits
...
\begin{figure}
	...
	\begin{tabular}{c|c|l|l|l|l|l|l|l|l|l|}
																	  \cline{5-9}\cline{2-3}\cline{11-11}
				    & Row n.     & F &  &   &   &   &   &   &  & L \\ \cline{5-9}\cline{2-3}\cline{11-11}
				    & 0          &   &  &   &   &   &   &   &  &   \\ \cline{5-9}\cline{2-3}\cline{11-11}
				    &            &   &  &   &   &   &   &   &  &   \\ \cline{5-9}\cline{2-3}\cline{11-11}
	$\Count{[}h{]}$ & 100        & h &  & a & s & h &   &   &  &   \\ \cline{5-9}\cline{2-3}\cline{11-11}
				    & 101        & h &  & e & a & d &   &   &  &   \\ \cline{5-9}\cline{2-3}\cline{11-11}
	                & 102        & h &  & i & n & d &   & b &  & e \\ \cline{5-9}\cline{2-3}\cline{11-11}
	$b_0$		    & 103        & h &  & o & u & s & e &   &  &   \\ \cline{5-9}\cline{2-3}\cline{11-11}
	                & 104        & h &  & o & u & s & e &   &  &   \\ \cline{5-9}\cline{2-3}\cline{11-11}
	$e_0$			& 105        & h &  & i & g & h &   &   &  &   \\ \cline{5-9}\cline{2-3}\cline{11-11}
	                & 106        &   &  &   &   &   &   &   &  &   \\ \cline{5-9}\cline{2-3}\cline{11-11}
	$b_1$           & 200        & o &  & u & s & e &   &   &  & m \\ \cline{5-9}\cline{2-3}\cline{11-11}
				    & 201        & o &  & u & s & e &   &   &  & h \\ \cline{5-9}\cline{2-3}\cline{11-11}
				    & 202        & o &  & u & s & e &   &   &  & m \\ \cline{5-9}\cline{2-3}\cline{11-11}
				    & 203        & o &  & u & s & e &   & s &  & p \\ \cline{5-9}\cline{2-3}\cline{11-11}
				    & 204        & o &  & u & s & e &   &   &  & h \\ \cline{5-9}\cline{2-3}\cline{11-11}
	$e_1$           & 205        &   &  &   &   &   &   &   &  &   \\ \cline{5-9}\cline{2-3}\cline{11-11}
	\end{tabular}
	}
