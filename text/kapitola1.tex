...
For simplicity, most of the time we shall assume in this section that every text $T$
contains a special character {\tt \$} located only at its end that is lexicographically
smallest.
...
This is particularly useful in bioinformatics, where we have a very long sequence
