...
space saving on some real-life data so we analyzed what is the possible space saving that can be
obtained on a data from \texttt{WT-WEB-1GB} and \texttt{WT-DNA-1GB}.
