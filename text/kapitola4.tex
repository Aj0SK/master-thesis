...
pair $(i, c-i)$. Example of these values can be observed in Fig.~\ref{table:class_pairs} but also
...
To measure the performance of our implementation, we mainly relied on two types of benchmarks.
