...
from the encoded pair $(c, o)$ and call the decoding subroutine on these two pairs.
...
made faster as it consists of only one table lookup. The second reason is that this part is blocking us
