...
In this chapter, we describe the implementation of ideas proposed in previous chapter
and the practical results we obtained when measuring experimentally their performance.
...
appendix A. However, to obtain the best possible results, our implementation requires
...
length 512 starting at random positions in text.
