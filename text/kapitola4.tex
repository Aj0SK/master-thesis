...
possible class $c$, numbers $C_{0}\ldots C_{c}$ where $C_i$ is the number of blocks
...
outperforms the binary search most of the time. In practice, we found that sequential search using
the \texttt{SIMD} instructions leads to the best results for a smaller block sizes. Possible 
