...
When implementing our decoding method, we identified the process of dividing our problem to sub-problems
...
inherently blocking us from solving the sub-problems. These sub-problems may be
