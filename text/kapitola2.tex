...
This procedure breaks short superblocks into blocks. Again, each of these blocks except for maybe the
...
of bits. To deal with the blocks smaller than $t_2^2$ we can again precompute a table of all
