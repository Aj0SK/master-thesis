...
succinct representation, in which we simply store bits one after another and use sublinear
space to support $\rank$ and $\select$. Then we look at the compressed representation using
the method introduced by \cite{raman2007succinct}. In the end, we briefly explain what other
alternatives exist for compressed bit vector implementation.
