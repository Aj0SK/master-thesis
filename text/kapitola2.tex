...
This solution is just like solution for the constant time $\rank$, based on a division to
...
every of them contains exactly $t_1$ ones (possibly except for the last).
