...
algoritmus RRR, deliaci postupnosť bitov na bloky, ktoré sú ďalej jednotlivo
komprimované. V tejto práci sme predstavili dve nové myšlienky kompresie a
dekompresie blokov. Tie sme naimplementovali a otestovali v umelých ale
aj reálnych podmienkach.
