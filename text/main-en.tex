...
% -------------------
\def\mfrok{2022}
\def\mfnazov{Engineering succinct data structures}
...
\paragraph*{Kľúčové slová:} úsporné dátové štruktúry
...
\paragraph*{Keywords:} succinct data structures, bit vector
