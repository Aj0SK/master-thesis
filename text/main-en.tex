...
Úsporné dátove štruktúry sú užitočnými v prípadoch keď je objem dát
s ktorými pracujeme obrovský a klasické dátové štruktúry by nás mohli
limitovať svojími pamäťovými nárokmi. Bitové pole s operáciami $\access$,
$\rank$ a $\select$ je stavebným kameňom mnohých prakticky užitočných
úsporných dátových štruktúr. Populárnou implementáciou bitového poľa je
algoritmus \textit{RRR}, deliaci postupnosť bitov na bloky, ktoré sú ďalej
jednotlivo komprimované. V tejto práci sme predstavili dve nové myšlienky
kompresie a dekompresie blokov. Tie sme naimplementovali a otestovali v
umelých ale aj reálnych podmienkach.
% TODO: nieco o FM-indexe
