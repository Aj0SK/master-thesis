...
are rare in their original bit representation. By using their original representation, we loose some
...
\emph{one-sided version of hybrid encoding}. The second version, for bit sequences that have balanced number
of zeroes and ones but contain many blocks with either small or big number of ones shall be called
\emph{two-sided version of hybrid encoding}.