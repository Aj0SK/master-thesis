...
representation $(c, o)$. When our new encoding scheme is used, the main part
...
zeroes and ones but contain many blocks with either small or big number of ones. We reffer to this one
as \emph{two-sided version of hybrid encoding} as it encodes standardly blocks containing either too
small or too big number of ones.