...
to create an alternative to the previous methods that enable a use of longer blocks
...
solutions of size $2^k-1$ together gives us only $2(2^k-1)$ what is one bit short of
