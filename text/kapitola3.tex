...
Although, the previous version of hybrid encoding may work well for sequences with low number
of ones. We would like to use this idea as a viable solution also for sequences that contain
...
corresponding block is stored in a raw form. This could be without loss of generality the
lowest value $\mathit{cut\_from}$. An example of this idea can be observed in
...
of class is still 7 and we need 3 bits store it. This would consume the same number
